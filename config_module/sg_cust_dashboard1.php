    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <ol class="carousel-indicators">
            <?php for ($x = 0; $x < $row_count; $x++) {
				if($x == 0){ ?>
					<li data-bs-target="#myCarousel" data-bs-slide-to="<?php $x ?>" class="active"></li>
            <?php  }else{
					?>
                    <li data-bs-target="#myCarousel" data-bs-slide-to="<?php $x ?>"></li>
					<?php
				}
			} ?>
        </ol>
...
//		while ($rowc = mysqli_fetch_array($qur)) {
        for ($slide_card_variable = 0; $slide_card_variable < $num_rows; $slide_card_variable++) {
                ...
                <div class="col-lg-3">
                    <div class="panel cell_bg">
                        <div class="panel-body" style="background-color:<?php echo $card_color; ?> !important;">
                            ...
                            <h3 class="no-margin dashboard_line_heading" style="font-size:x-large !important;"><?php echo $rowc["line_name"]; ?></h3>
                            <hr/>
                        ...
                        <div style="height: 100%;">
                            <h4 class="text_white" style="font-size:x-large !important;height:inherit;text-align: center;background-color:<?php echo $buttonclass; ?>;">
