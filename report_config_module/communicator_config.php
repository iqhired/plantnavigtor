...
if (count($_POST) > 0) {
    ...
    $sql = "update sg_communicator_config set teams='$array_team',users='$array_user',subject='$_POST[subject]',message='$_POST[message]',signature='$_POST[signature]' where sg_communicator_config_id='2'";
                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                ...
                                <hr/>
                                <?php
                                $query = sprintf("SELECT * FROM  sg_communicator_config");
