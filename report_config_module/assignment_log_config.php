...
if (count($_POST) > 0) {
    ...
    $sql = "update sg_assignment_log_config set teams='$array_team',users='$array_user',subject='$_POST[subject]',message='$_POST[message]',signature='$_POST[signature]' where sg_assignment_log_config_id='2'";
