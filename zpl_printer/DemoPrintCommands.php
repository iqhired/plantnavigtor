<?php 
  ...
  $title = 'WebClientPrint for PHP - Print Commands Demo';
...
?>
 ...
 <h3><a href="Samples.php" class="btn btn-md btn-danger"><i class="fa fa-chevron-left"></i></a>&nbsp;Print Raw/Text Commands</h3>
