...
$station_event_old_id = $row_st['station_event_log_id'];

$sql0 = "SELECT * FROM sg_station_event_log where station_event_log_id > '$station_event_old_id' AND created_on <= '$chicagotime1'";
