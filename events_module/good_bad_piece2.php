...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <!-- /user menu -->
        <!-- Main navigation -->
        <?php if($is_tab_login || ($_SESSION["role_id"] == "pn_user")){include("../tab_menu.php");}else{
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div style="background-color: #fff;padding-bottom: 50px;" class="row">
                ...
                <div class="row">
                    <div class="panel panel-flat">
                        ...
                        $tp = $gp + $bp+ $rwp;
                        ?>
                        <div class="row" style="background-color: #f3f3f3; margin:10px;">
                            ...
                            <div class="col-md-3" style="height: 10vh; padding-top: 3vh; font-size: x-large; text-align: center;background-color:#a8d8a8;">
                                <span>Total Good Pieces : <?php echo $gp ?></span>
                            </div>
                            <div class="col-md-3" style="height: 10vh; padding-top: 3vh; font-size: x-large; text-align: center;background-color:#eca9a9;">
                                <span>Total Bad Pieces : <?php echo $bp ?></span>
                            </div>
                            <div class="col-md-3" style="height: 10vh; padding-top: 3vh; font-size: x-large; text-align: center;background-color:#b1cdff;">
                                <span>Rework : <?php echo $rwp ?></span>
                            </div>
                        </div>
                        <div class="panel-heading" style="padding-top:50px;padding-bottom: 50px;">
                            <div class="row">
                                <div class="search_container"  style="margin-right:10px;">
                                    <input id="search" class="search__input"  type="text" placeholder="Search Defect" style="float:right;width: 25%;padding: 12px 24px;background-color: transparent;transition: transform 250ms ease-in-out;line-height: 18px;color: #000000;font-size: 18px;background-color: transparent; background-repeat: no-repeat;
        ...
        " >
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#view_good_modal_theme_primary" style="background-color:#177b09;margin-top: 10px;width: 100%;height: 10vh; padding-top: 1vh; font-size: large; text-align: center;">IN-SPEC</button>
                                </div>
                            </div>
                            <div class="row">
                                <?php
                                ...
                                while ($row1 = $result1->fetch_assoc()) {
                                    ...
                                    <div class="col-md-3">
                                        <button type="button" id="view" class="btn btn-primary view_gpbp"  data-buttonid="<?php echo $row1['defect_list_id']; ?>" data-toggle="modal"
                                                data-target="#view_modal_theme_primary"  data-defect_name="<?php echo $row1['defect_list_name']; ?>" style="white-space: normal;background-color:#BE0E31;height: 10vh; width:98% ; padding-top: 1vh; font-size: medium; text-align: center;"><?php echo $row1['defect_list_name']; ?></button>
            ...
            <div id="view_good_modal_theme_primary" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
