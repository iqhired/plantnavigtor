...
//multiple image
    if($edit_file != "") {
        if (isset($_FILES['edit_image'])) {
            ...
            foreach ($_FILES['edit_image']['name'] as $key => $val) {
                $errors = array();
                $file_name = $_FILES['edit_image']['name'][$key];
                $file_size = $_FILES['edit_image']['size'][$key];
                $file_tmp =  $_FILES['edit_image']['tmp_name'][$key];
                $file_type = $_FILES['edit_image']['type'][$key];
                ...
                if (empty($errors) == true) {
                    ...
                    $sql = "update material_images set image_name='$file_name' where material_id = '$form_id'";
