                        ...
                        <div class="col-md-12">
                            <form action="edit_fs_backend.php"  enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="need_approval" id="need_approval" class="select form-control"
                                                data-style="bg-slate">
                                                        ...
                                                        <div class="qry_section" id="section_<?php echo $rowcount; ?>">
                                                            ...
                                                            <div class="list_section"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <label class="col-lg-2 control-label" for="default">List Enabled/Disabled:</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-check form-check-inline">
                                                                            ...
                                                                            <input type="checkbox" class="checkbox-control" name="list_enabled_<?php echo $rowcount; ?>[]"  id="list_enabled"<?php if($enabledlist == 1){ echo 'checked';}else if($enabledlist == 0){}?>>
