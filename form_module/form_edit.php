...
<!--										</div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <select name="need_approval" id="need_approval" class="select form-control" data-style="bg-slate">
		...
		<div id="<?php echo $rowcount; ?>" class="panel-collapse collapse in">
			<div class="panel-body">
				<div class="qry_section" id="section_<?php echo $rowcount; ?>">
                    <div class="row">
                        <div class="col-md-2">
                            <input type="checkbox" id="optional_<?php echo $rowcount; ?>[]" name="optional_<?php echo $rowcount; ?>[]" <?php if($rowcitem['optional'] == "1"){ echo 'checked'; } ?> class="checkbx" style="margin-right:15px;"/>Optional
                        </div>
                    </div>
                    </br>
					<div class="row">

							<label class="col-lg-2 control-label" for="query_text">Item Description :</label>
					...
					<div class="row">
							...
							<label class="col-lg-2 control-label" for="item_class">Form Item Type:</label>
					...
					<div class="numeric_section" id="numericsection_<?php echo $rowcount; ?>" <?php if($item_val != "numeric"){ echo "style='display:none;'"; } ?>>
						<div class="row">
								...
								<label class="col-lg-2 control-label" for="normal">Measurement Unit:</label>
						...
						<div class="row">
								...
								<label class="col-lg-2 control-label" for="lower_tolerance">LowerTolerance:</label>
						...
						<div class="row">
								...
								<label class="col-lg-2 control-label" for="upper_tolerance">UpperTolerance:</label>
					...
					<div class="binary_section" id="binarysection_<?php echo $rowcount; ?>" <?php if($item_val != "binary"){ echo "style='display:none;'"; } ?>>
						...
						<div class="row">
								...
								<label  class="col-lg-2 control-label" for="yes_alias">Yes Alias:</label>
						...
						<div class="row">
								...
								<label class="col-lg-2 control-label" for="no_alias">No Alias:</label>
...
$rowcount++;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" id="form_save_btn" class="btn btn-primary submit_btn" style="background-color:#1e73be;">Save</button>
                                        </div>
                                    </div>
                                    <br/> </form>
                            </div>
