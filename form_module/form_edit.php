...
<script>
    ...
    $(document).on('change', 'input[type="checkbox"]', function (e) {
        ...
        var extraCount = 0;
        if(null == this.parentElement.parentElement.parentElement.parentElement.childNodes[1].childNodes[1]){
            extraCount = 0;
        }else if(null != this.parentElement.parentElement.parentElement.parentElement.childNodes[1].parentElement.getElementsByClassName('list_section')){
