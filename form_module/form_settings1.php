...
//														$entry = 'selected';
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            <input type="text" class="form-control" name="po_number" id="po_number" placeholder="Name" required>
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            <input type="text" class="form-control" name="da_number" id="da_number" placeholder="Name" required>
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-4">
            ...
            <div class="col-lg-10 col-xl-10 col-md-12 col-sm-12">
                <div class="card  box-shadow-0">
                    <div class="card-body pt-0">
                        <button class="btn btn-primary pd-x-30 mg-r-5 mg-t-5" name="add_more" id="add_more"><i class="fa fa-plus"></i> ADD MORE FORM ITEMS</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-10 col-xl-10 col-md-12 col-sm-12">
                <div class="card  box-shadow-0">
                    <div class="card-body pt-0">
                        <button type="submit" class="btn btn-primary pd-x-30 mg-r-5 mg-t-5" id="form_submit_btn" class="btn btn-primary submit_btn">Register</button>
                    </div>
                </div>
            </div>
        </div>
