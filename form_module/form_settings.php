...
<script>
    $(document).on("click",".add_option",function() {
        ...
        $('#add_other_' + index).append('<div id="list_' + index + '">' + '<input type="radio" class="custom-control-input" name="default_list_' + index + '[]" value="radio_extra_' + index + '[]">' + '<input type="search" name="radio_list_extra[]" id="radio_list_extra[]" value="" class="radio_input">' + '<button class="remove" onclick="removeDiv(this);">X</button>' + "</div>");
