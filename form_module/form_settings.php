...
<script>
    ...
    function addoptions() {
        $('#add_other').append('<div>' + '<input type="radio" class="custom-control-input" name="defaultExampleRadios">' + '<input type="search" name="" value="" class="radio_input_add">' + '<button class="remove" onclick="removeDiv(this);">X</button>' + "</div>");
    }
