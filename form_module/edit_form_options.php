						...
						while ($rowc = mysqli_fetch_array($qur)) {
                            ...
                            <tr>
                                <td><input type="checkbox" id="delete_check[]" name="delete_check[]"
                                           value="<?php echo $rowc["form_create_id"]; ?>"></td>
                                ...
                                <td>
                                    ...
                                    <a href="form_edit.php?id=<?php echo $rowc['form_create_id']; ?>"
                                       class="btn btn-primary" style="background-color:#1e73be;">Edit Form</a>
                                </td>
                            </tr>
						<?php } ?>
                        </tbody>
